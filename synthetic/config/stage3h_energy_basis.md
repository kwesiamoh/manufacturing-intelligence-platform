...
Stage 3H uses these measurements as an anchor, not as claimed measurements from the fictional sites.
...
The can-line value uses the same generic Stage 3H formula as PET:
...
Real Step 9 steam/compressed-air data and Step 10 water data remain available for benchmark/reference analytics later.
