# Step 12 — Real Industrial Greenhouse-Gas / CO2 Emissions Data
...
This project will use the stationary-installation records as a real European industrial-emissions benchmark.
...
- calibration of later emissions-intensity scenarios where clearly documented;
...
worksheet semantics still require documented review. Redistribution/license
status is not inferred here and remains open for Stage 16A.9/final release.
