# Step 8 — Industrial Energy Cost & Improvement Benchmark
...
3. Later Gold models may aggregate by industry, recommendation category, energy type, savings,
   project cost, payback, and implementation status.
