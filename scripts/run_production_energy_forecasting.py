...
def main():
    ...
    print("=== production and energy forecasting production and energy forecasting ===")
    daily = load_daily()
    ...
    with open(rep/"production_energy_forecasting_metrics.json", "w", encoding="utf-8") as f:
    ...
    print((rep/"production_energy_forecasting_metrics.json").relative_to(repo))
    print("=== production and energy forecasting complete ===")
