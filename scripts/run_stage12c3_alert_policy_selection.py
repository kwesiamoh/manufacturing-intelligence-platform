...
def main():
    ...
    fpath = repo / "sources" / "step02-telemetry" / "data" / "bronze" / "metropt3" / "reference" / "failure_windows.csv"
    ...
    with open(reportdir / "stage12c3_alert_policy_selection.json", "w", encoding="utf-8") as f:
        json.dump(report, f, indent=2)

    print("=== Stage 12C.3 alert policy selection ===")
