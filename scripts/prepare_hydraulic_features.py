...
def main():
    ...
    base = repo / "sources" / "hydraulic-condition-monitoring" / "silver" / "reliability"
    ...
    print("=== hydraulic feature preparation real hydraulic condition classification ===")
    ...
    report_path = report_dir / "hydraulic_feature_preparation_metrics.json"
    ...
    print("=== hydraulic feature preparation complete ===")
