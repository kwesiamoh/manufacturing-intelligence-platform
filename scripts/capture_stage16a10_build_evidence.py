...
DEFAULT_JSON = (
    REPO_ROOT / "reports" / "reproducibility" / "stage16a10_build_evidence.json"
)
DEFAULT_SUMMARY = (
    REPO_ROOT / "docs" / "reproducibility" / "stage16a10_clean_build_proof.md"
)
BUILD_LOG = (
    REPO_ROOT
    / "logs"
...
ENERGY_MANIFEST = REPO_ROOT / "config" / "stage3h_energy_artifact_manifest.json"
...
def capture(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if "sql/analytics/742_create_stage13d2_corrected_reliability_trends.sql" not in normalized_log:
